...
<div class="modal fade" id="createBasketModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
function getBaskets() {
  $.ajax({
    ...
    error:function(e){
         $("#baskets").removeClass("loading");
        console.log(e,"hhhhhhhhhhhhhhhhhhhhhhhhh");
    }
  });
}
